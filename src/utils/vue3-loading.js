...
class LoadingClass {
    constructor() {
        ...
        this.g_contextLoading = [];
        this.globalLoadingNum = 0;
        this.loadingInstance = null;

        this.globalContext = null;

        this.closeGlobalInstanceTimeout = -1;
    }
    ...
    add(context = null) {
        ...
        const existLoadingContext = this.g_contextLoading.find((item) => {
    ...
    remove(context = null) {
        ...
        if (existLoadingContext.loadingNum <= 0) {
            ...
            this.g_contextLoading = this.g_contextLoading.filter((item) => {
                return item.context != context;
            });
        }
    }
