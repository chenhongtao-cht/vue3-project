<template>
  <div class="vue-cropper">
    <div class="vue-cropper-card" @mousemove="cardMouseMove" @mouseup="() => {
      clipDown = false;
      dotDown = false;
    }" :style="{
  width: `${width}px`,
  height: `${height}px`,
      ...
      <div class="vue-cropper-clip" ref="clip" :style="clipStyle" @mousedown="clipDown = true"
        ...
        <div class="dot bottom-center" @mousedown="register('bottomcenter')"></div>
        <div class="dot bottom-right" @mousedown="register('bottomright')"></div>
        <div class="dot left-center" @mousedown="register('leftcenter')"></div>
        <div class="dot right-center" @mousedown="register('rightcenter')"></div>
      </div>
    </div>
    <div class="vue-cropper-btn">
...
export default {
  ...
  setup(props: any, { emit }: any) {
    ...
    const initCanvas = (e: Event) => {
      ...
      console.log(cardBg.value, 'cardBg.value');
